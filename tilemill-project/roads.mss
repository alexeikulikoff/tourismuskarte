...
@cycleway-fill: #b7b7b7;
@bridleway-fill: #b7b7b7;
@byway-fill: #ffcc00;
@track-fill: #666666;
@track-grade1-fill: #666666;
@track-grade2-fill: #666666;
@aeroway-fill: #bbc;
...
@motorway-casing: #F30B0B;
@trunk-casing: #000000;
@primary-casing: #000000;
@secondary-casing: #000000;
@tertiary-casing: #000000;
@residential-casing: #bbb;
@service-casing: #999;
@living-street-casing: #bbb;
@pedestrian-casing: black;
...
#tunnels::casing {
  ...
  [highway = 'trunk_link'] {
    ...
    [zoom >= 15] { line-width: 11; line-color: #000000; }
    [zoom >= 17] { line-width: 14; line-color: #000000; }
  }
  ...
  [highway = 'secondary_link'] {
    ...
    [zoom >= 15] { line-width: 12; line-color: #000000; }
    [zoom >= 17] { line-width: 17; line-color: #000000; }
  }
...
#minor-roads-fill::links {
  ...
  [feature = 'highway_secondary_link'][tunnel != 'yes'] {
    ...
    [zoom >= 15] { line-width: @secondary-width-z15; line-color: #ffffff; }
    [zoom >= 17] { line-width: @secondary-width-z17; line-color: #ffffff;  }
  }
...
.bridges {
  ...
  ::bridges_fill {
    ...
    [feature = 'highway_trunk_link'] {
      ...
      [zoom >= 13] { line-width: 7; }
      [zoom >= 15] { line-width: 9.5; line-color: #ffffff; }
      [zoom >= 17] { line-width: 14.5; line-color: #ffffff; }
    }
...
#roads-text-ref {
  ...
  [highway = 'primary'][zoom >= 13][zoom < 15] {
    shield-name: "[ref]";
    shield-size: 10;
    shield-fill: #fff;
    shield-placement: line;
  ...
  [highway = 'secondary'][bridge = 'no'][zoom >= 13][zoom < 15] {
    shield-name: "[ref]";
    shield-size: 10;
    shield-fill: #fff;
    shield-placement: line;
  ...
  [highway = 'tertiary'][bridge = 'no'][zoom >= 13][zoom < 15] {
    shield-name: "[ref]";
    shield-size: 10;
    shield-fill: #fff;
    shield-placement: line;
