.points {
  [tourism = 'alpine_hut'][zoom >= 15]::tourism {
    point-file: url('symbols/logos/svg/alpine_hut.svg');
    point-placement: interior;
  }

  [tourism = 'zoo'][zoom >= 17]::tourism {
    point-file: url('symbols/logos/svg/zoogroß.svg');
    point-placement: interior;
  } 
...
/*  [amenity = 'bank'][zoom >= 17]::amenity {
  ...
  [amenity = 'bar'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/Bar.svg');
    point-placement: interior;
  }

  [amenity = 'bicycle_rental'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/bicycle.svg');
    point-placement: interior;
  }
  ...
  [highway = 'bus_stop']::highway {
    ...
    [zoom >= 17] {
      point-file: url('symbols/logos/svg/BusstopStation.svg');
    }
  }

  [amenity = 'bus_station'][zoom >= 15]::amenity {
    point-file: url('symbols/logos/svg/Bus_halt.svg');
    point-placement: interior;
  }
  ...
  [amenity = 'cafe'][zoom >=17]::amenity {
    point-file: url('symbols/logos/svg/Cafe.svg');
    point-placement: interior;
  }

  [tourism = 'camp_site'][zoom >= 15]::tourism {
    point-file: url('symbols/logos/svg/camping.svg');
    point-placement: interior;
  }
 ...
 /* [highway = 'ford'][zoom >= 16]::highway {
  ...
  [tourism = 'caravan_site'][zoom >= 16]::tourism {
    point-file: url('symbols/logos/svg/caravan.svg');
    point-placement: interior;
  }
...
/*  [amenity = 'car_sharing'][zoom >= 16]::amenity {
  ...
  [amenity = 'cinema'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/cinema.svg');
    point-placement: interior;
  }
 ...
 /* [amenity = 'fuel'][zoom >= 17]::amenity {
  ...
  [tourism = 'guest_house'][zoom >= 17]::tourism {
    point-file: url('symbols/logos/svg/guesthouse2.svg');
    point-placement: interior;
  }

  [tourism = 'bed_and_breakfast'][zoom >= 17]::tourism {
    point-file: url('symbols/logos/svg/bedbreakfast2.svg');
    point-placement: interior;
  }
  ...
  [tourism = 'hostel'][zoom >= 17]::tourism {
    point-file: url('symbols/logos/svg/hostel2.svg');
    point-placement: interior;
  }

  [tourism = 'hotel'][zoom >= 17]::tourism {
    point-file: url('symbols/logos/svg/hotel2.svg');
    point-placement: interior;
  }

  [tourism = 'motel'][zoom >= 17]::tourism {
    point-file: url('symbols/logos/svg/motel.svg');
    point-placement: interior;
  }

  [tourism = 'information'][zoom >= 15]::tourism {
    point-file: url('symbols/logos/svg/info.svg');
    point-placement: interior;
  }
 ...
 /* [amenity = 'embassy'][zoom >= 17]::amenity {
  ...
  [amenity = 'library'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/library.svg');
    point-placement: interior;
  }
 ...
 /* [man_made = 'mast'][zoom >= 17]::man_made {
  ...
  [historic = 'castle'][zoom >= 17]::historic {
    point-file: url('symbols/logos/svg/castle.svg');
    point-placement: interior;
  }

  [tourism = 'museum'][zoom >= 17]::tourism {
    point-file: url('symbols/logos/svg/museum.svg');
    point-placement: interior;
  }

  [amenity = 'parking'][zoom >= 15]::amenity {
    point-file: url('symbols/logos/svg/Parkplatz.svg');
    point-placement: interior;
    [access != ''][access != 'public'][access != 'yes'] {
      point-file: url('symbols/logos/svg/privatparkplatz.svg');
    }
  }
 ...
 /* [amenity = 'pharmacy'][zoom >= 17]::amenity {
  ...
  [amenity = 'place_of_worship'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/church.svg');
    point-placement: interior;
    [religion = 'christian'] {
      point-file: url('symbols/logos/svg/church.svg');
    }
    [religion = 'muslim'] {
      point-file: url('symbols/logos/svg/muslim.svg');
    }
  /*  [religion = 'sikh'] {
      point-file: url('symbols/sikh3.p.16.png');
    }*/
    [religion = 'jewish'] {
      point-file: url('symbols/logos/svg/jewish.svg');
    } 
  }
...
/*  [amenity = 'post_office'][zoom >= 17]::amenity {
  ...
  [amenity = 'pub'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/Pub2.svg');
    point-placement: interior;
  }

  [amenity = 'biergarten'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/Biergarten.svg');
    point-placement: interior;
  }
  ...
  [amenity = 'restaurant'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/Restaurantrahmen2.svg');
    point-placement: interior;
  }

  [amenity = 'fast_food'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/Fastfood.svg');
    point-placement: interior;
  }
 ...
 /* [amenity = 'emergency_phone'][zoom >= 17]::amenity {
  ...
  [amenity = 'theatre'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/theatre.svg');
    point-placement: interior;
  }

  [amenity = 'toilets'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/toilet.svg');
    point-placement: interior;
  }
  ...
  [tourism = 'viewpoint'][zoom >= 15]::tourism {
    point-file: url('symbols/logos/svg/viewpoint.svg');
    point-placement: interior;
  }
 ...
 /* [man_made = 'water_tower'][zoom >= 17]::man_made {
  ...
  [historic = 'memorial'][zoom >= 17]::historic {
    point-file: url('symbols/logos/svg/monument.svg');
    point-placement: interior;
  }
 ...
 /* [shop = 'clothes']::shop,
  ...
  [leisure = 'playground'][zoom >= 17]::leisure {
    point-file: url('symbols/logos/svg/playground.svg');
    point-placement: interior;
  }

  [amenity = 'picnic_site'][zoom >= 17]::amenity {
    point-file: url('symbols/logos/svg/picnic.svg');
    point-placement: interior;
  }
...
*/
 ...
 /* [amenity = 'prison'][zoom >= 17]::amenity {
  ...
  [tourism = 'attraction'][zoom >= 17]::tourism {
    text-name: "[name]";
    text-size: 10;
    text-fill: #8A0868;
    text-face-name: @book-fonts;
